...
import { X, Copy, Heart, QrCode, CreditCard, CheckCircle } from "lucide-react";
...
const BANK = {
  ...
  account: "0911111111",
  holder: "NGUYEN MINH THU",
  content: "Nuoi Thu Soi",
};
      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative bg-background rounded-[2rem] shadow-2xl border border-border/40 w-full max-w-md overflow-hidden"
          >
            {/* Gradient top */}
            ...
            <div className="px-8 pt-6 pb-8">
              ...
              <div className="text-center mb-6">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-rose-100 to-primary/20 flex items-center justify-center mx-auto mb-4 border border-rose-200/50">
                  <span className="text-3xl">🐺</span>
                </div>
                <h2 className="text-2xl font-serif font-bold mb-1">Góp tiền nuôi Thư Sói</h2>
                <p className="text-muted-foreground text-sm">Mỗi đồng ủng hộ là thêm một nụ cười cho Thư 🩷</p>
              </div>

              {/* QR Code */}
              <div className="bg-white rounded-2xl p-4 mb-5 flex items-center justify-center shadow-inner border border-border/20">
                <img
                  src={qrUrl}
                  alt="QR Chuyển khoản"
              ...
              <div className="space-y-3 mb-6">
                {[
                  ...
                  { label: "Nội dung", value: BANK.content, key: "content" },
                ].map(({ label, value, key }) => (
                  <div
                    key={key}
                    className="flex items-center justify-between gap-3 bg-muted/50 rounded-xl px-4 py-3"
                  >
                    <div>
